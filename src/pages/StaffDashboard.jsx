...
import { Calendar, CheckCircle, Clock, XCircle, Zap, Activity, Shield } from 'lucide-react';
...
export default function StaffDashboard() {
  const { user } = useAuth();
  const { date, time, dateKey } = useClock(); // 🚀 സമയം കൂടി എടുത്തു
  ...
  // ഫ്രെയിമർ മോഷൻ ആനിമേഷൻ വേരിയന്റുകൾ (For smooth entry)
